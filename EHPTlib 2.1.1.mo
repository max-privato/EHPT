      ...
      equation
        ...
        annotation (
          ...
          Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(extent = {{-70, 80}, {100, -80}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255},
                  ...
                  fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent={{-48,14},
                    {70,-16}}),                                                                                                                                                                                                        Text(origin={6.2759,
                    37},                                                                                                                                                                                                        extent={{
                    -52.2759,-27},{59.7241,-47}},                                                                                                                                                                                                        textString = "J=%J")}),
          Documentation(info = "<html>
        ...
        annotation (
          ...
          Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(extent = {{-70, 80}, {100, -80}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255},
                  ...
                  fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent={{-48,14},
                    {70,-16}}),                                                                                                                                                                                                        Text(origin={6.2759,
                    39.7},                                                                                                                                                                                                        extent={{
                    -52.2759,-29.7},{59.7241,-51.7}},                                                                                                                                                                                                        textString = "J=%J")}),
          Documentation(info="<html>
...
<p>The input signal is the requested normalised torque (1 means nominal torque)</p>
      ...
      partial model PartialOneFlange2LF
        ...
        parameter Modelica.Units.SI.MomentOfInertia J=0.25
          "Rotor's moment of inertia";
        parameter String limitsFileName = "noName" "File where limit matrces are stored" annotation (
          Dialog(enable = effMapOnFile or limitsOnFile, loadSelector(filter = "Text files (*.txt)", caption = "Open file in which required tables are")));
        parameter Boolean limitsOnFile = false "= true, if torque limits are taken from a txt file";
        parameter Modelica.Units.SI.Power powMax=22000
          "Maximum mechnical power" annotation (Dialog(enable=not limitsOnFile));
      ...
      equation
        ...
        annotation (
          ...
          Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(extent = {{-70, 80}, {100, -80}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255},
                  ...
                  fillPattern =                                                                                                                                                                                                        FillPattern.Solid, fillColor = {255, 255, 255}), Rectangle(fillColor = {192, 192, 192},
                  fillPattern =                                                                                                                                                                                                        FillPattern.HorizontalCylinder, extent = {{-56, 48}, {76, -48}}), Rectangle(fillColor = {255, 255, 255},
                  fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent={{-50,28},
                    {70,-28}}),                                                                                                                                                                                                        Text(origin={5.2094,
                    51.7},                                                                                                                                                                                                        extent={{
                    -53.2094,-29.7},{60.7906,-51.7}},                                                                                                                                                                                                        textString = "J=%J"),
                                                                                                                                                                                                        Text(origin={8.1429,
                    32.4},                                                                                                                                                                                                        extent={{
                    -54.1429,-32.4},{61.8571,-56.4}},
                textString="LF",
                textColor={238,46,47},
...
<p>When the final speed is reached, the feeding frequenccy and voltage are kept constant (no flux weaking simulated)</p>
      ...
      model AsmaTqFollowing "Compares U/f=cost and mains start-ups"
        ...
        EHPTlib.ElectricDrives.ASMArelated.ControlLogic logic(
          ...
          uBase=200*sqrt(3),
          weBase=500,
          wmMax=314.16) annotation (Placement(visible=true, transformation(
...
<p>Here control on current amplitude <b>is </b>implemented, which becomes active during the central part of the simulation; in this case only part of the requested toque is delivered.</p>
      ...
      model SmaAllSpeeds
        ...
        Modelica.Electrical.Machines.BasicMachines.SynchronousMachines.SM_PermanentMagnet smpm1(Lmd = 2e-3, Lmq = 4e-3, Lssigma(start = 1e-5), phiMechanical(displayUnit = "rad"), useDamperCage = false, wMechanical(displayUnit = "rad/s")) annotation (
      ...
      equation
        ...
        annotation (
          Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-120,
                  -80},{120,60}}),                                                                  graphics={  Rectangle(origin={-16,-114},    lineColor = {238, 46, 47}, pattern = LinePattern.Dash, extent = {{4, 166}, {52, 130}})}),
          __Dymola_experimentSetupOutput,
          Documentation(info = "<html>
    <p>Permanent magnet synchronous machine drive with MTPA control specifically designed for isotropic machines.</p>
    <p>Initially the transient has low speed and no Id is needed: the control chose therefore Id=0.</p>
